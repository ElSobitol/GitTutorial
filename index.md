...
Если у нас нет доступа к нужному удалённому репозиторию, но внести в него изменения необходимо, используют pull request. Для этого:

1. Находим на Githab нужный репозиторий.
2. Делаем свою отдельную копию этого репозитория на свой аккаунт, с помощью "Fork".
3. Уже со своего аккаунта клонируем его (git clone) в свой локальный.
4. При помощи "cd" переходим в нужный репозиторий.
5. Создаём отдельную ветку для изменений.
6. Создаём файл README.
7. Вносим изменения и закомичиваем их.
8. Отправляем эти изменения на свой аккаунт.
9. Обговляем Githab и через Compare & pull request предлагаем свои изменения хозяину репозитория.
10. Добавляем описание к проекту.
11. Отправляем pull request в изначальный аккаунт.
