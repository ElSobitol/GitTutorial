...
```
git add somefile.js # добавление всех файлов git add .
```
...
```
git log (git log --graph --oneline --decorate)
``` 
...
<style>
    H1 {color: SkyBlue;}
    h2 {color: SkyBlue;}
    pre{color: NavajoWhite;}
    code{color: NavajoWhite;}
</style>
