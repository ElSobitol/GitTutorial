...
Чтобы отправить данные в удаленный репозиторий, необходимо выполнить команду:
...
Для просмотра созданных веток, необходимо выполнить команду:
...
Переход на существующую ветку реализует команда:

```bash
git checkout [ имя ветки]
```

Также для перехода между ветками можно использовать команду:
...
Для того чтобы выполнить слияние веток, необходимо выполнить команду:

```bash
git merge [ имя ветки которую необходимо слить с активной]
```

## Ликвидация веток с удаленного сервера

Для того чтобы удалить ветку с удаленного сервера, необходимо выполнить команду:
